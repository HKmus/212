...
export function Pill({ children, dot, tone = "default" }) {
  const tones = {
      ...
      {dot && (
        <span
          style={{
            ...
            background: t.fg,
            animation:
              dot === "pulse" ? "pulse 1.6s ease-in-out infinite" : "none",
          }}
        />
      )}
      {children}
...
export function Btn({
  ...
  const S = {
    ...
    urgent: { bg: "var(--urgent)", fg: "white", bd: "var(--urgent)" },
    ghost: { bg: "transparent", fg: "var(--fg)", bd: "var(--border-2)" },
    solid: { bg: "var(--fg)", fg: "var(--bg)", bd: "var(--fg)" },
    soft: { bg: "var(--surface-2)", fg: "var(--fg-2)", bd: "var(--border)" },
  };
      ...
      style={{
        ...
        boxShadow:
          kind === "primary"
            ...
            : kind === "urgent"
              ? "0 10px 28px -10px var(--urgent-glow)"
              : "none",
...
export function PillBadge({ children, tone = "default" }) {
  const T = {
    default: { fg: "var(--muted)", bg: "var(--surface-2)" },
    accent: { fg: "var(--accent-2)", bg: "var(--accent-soft)" },
    warn: { fg: "#fbbf24", bg: "rgba(251,191,36,0.12)" },
    urgent: { fg: "var(--urgent-2)", bg: "var(--urgent-soft)" },
  };
...
export function SvcIcon({ svc, size = 22 }) {
...
export function APill({ children, tone = "default" }) {
  const T = {
    default: { fg: "var(--muted)", bg: "var(--surface-2)" },
    accent: { fg: "var(--accent-2)", bg: "var(--accent-soft)" },
    warn: { fg: "#fbbf24", bg: "rgba(251,191,36,0.12)" },
...
export function ACard({ title, action, children, pad = 0, style: ext }) {
  return (
    <section
      style={{
...
export function PortalCard({ title, action, children, pad = 24 }) {
  return (
    <section
      style={{
        background: "var(--surface)",
    ...
    >
      <div style={{ flex: 1, minWidth: 200 }}>
        ...
        <div style={{ fontSize: 13, color: "var(--fg-2)", lineHeight: 1.4 }}>
          Essential cookies keep the site running. Analytics cookies (if
          accepted) help us improve. No data sold.{" "}
          <a
            href="#privacy"
...
export function Toast({ msg, onClose }) {
  ...
  return (
    ...
    >
      <span style={{ color: "var(--accent-2)", fontSize: 20, lineHeight: 1 }}>
        ✓
      </span>
      <div style={{ flex: 1 }}>
        ...
        <div style={{ fontSize: 13, color: "var(--fg-2)" }}>{msg}</div>
      </div>
      <button
        onClick={onClose}
        style={{
          ...
          {done ? (
            <div style={{ textAlign: "center", padding: "32px 0" }}>
              ...
              <div style={{ fontSize: 16, fontWeight: 600, marginBottom: 8 }}>
                We'll call you within 8 minutes
              </div>
              <div
                style={{
                  color: "var(--fg-2)",
              ...
              >
                ...
                <strong style={{ color: "var(--fg)" }}>020 3488 0664</strong>{" "}
                shortly with your fixed quote.
              </div>
              <div
                style={{ display: "flex", gap: 10, justifyContent: "center" }}
              >
                <a href="tel:02034880664">
                  <button
                    style={{
                      padding: "12px 20px",
            ...
            <>
              <p
                style={{ color: "var(--fg-2)", fontSize: 14, marginBottom: 20 }}
              >
                Choose the service you need. We'll get you a fixed quote, fast.
              </p>
              <div
                style={{
                  display: "grid",
            ...
            <>
              ...
              >
                <span style={{ fontSize: 14, color: "var(--accent-2)" }}>
                  ✓
                </span>
                <span
                  className="mono"
              ...
              <input
                ...
                type="email"
              />
              <label style={lbl}>Address / postcode *</label>
              <input
                style={inp}
                value={form.address}
                ...
                required
              />
              <label style={lbl}>Any details</label>
              <textarea
              ...
              <button
                onClick={submit}
                disabled={
                  submitting || !form.name || !form.phone || !form.address
                }
                style={{
                  width: "100%",
                  padding: "14px",
              ...
              >
                We'll call you back within 8 minutes with a fixed price. No
                obligation.
              </p>
            </>
          )}
