  ...
  return (
    ...
    >
      ...
      <div style={{ padding: 22 }}>
        ...
        <div style={{ fontSize: 14, color: "var(--fg-2)", marginBottom: 22 }}>
          Camden, NW1 · ETA in{" "}
            ...
            >
              <span
                style={{
                  ...
                  boxShadow:
                    s.on === "active" ? "0 0 0 6px var(--accent-soft)" : "none",
                }}
              >
                {s.on === true && (
                  <svg
    ...
    >
      ...
      >
        <div>
          ...
          >
            Drop us a message and our operations team will call you back within
            2 hours during business hours, or first thing next morning.
          </p>
        ...
        >
          ...
          <button
            ...
            style={{
              ...
              border: "none",
              opacity:
                sending || !form.name || !form.email || !form.msg ? 0.5 : 1,
            }}
          >
  ...
  return (
    ...
    >
      <div style={{ maxWidth: 540, margin: "0 auto", textAlign: "center" }}>
        ...
        >
          Pay your invoice online using our secure Stripe payment link. All
          major cards accepted. Receipt sent instantly.
        </p>
        <div
          style={{
            background: "var(--surface)",
        ...
        >
          ...
          >
            {["VISA", "MC", "AMEX", "GOOGLE PAY", "APPLE PAY"].map((c, i) => (
              <div
                key={i}
                style={{
                  padding: "5px 9px",
      ...
      <div style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        >
          <p>
            ...
            is committed to protecting your personal data in compliance with the
            UK GDPR and Data Protection Act 2018.
          </p>
          <p>
            <strong style={{ color: "var(--fg)" }}>Data we collect:</strong>{" "}
            Name, phone number, email address, delivery/service address, and job
            details you provide when requesting a quote or booking. Analytics
            data (pages visited, time on site) if you consent to non-essential
            cookies.
          </p>
          <p>
            <strong style={{ color: "var(--fg)" }}>How we use it:</strong> To
            fulfil your service request, send job confirmations, and improve our
          ...
          <p>
            ...
            enquiries are deleted after 2 years if no ongoing relationship.
          </p>
          <p>
            <strong style={{ color: "var(--fg)" }}>Payments:</strong> Payment
            processing is handled entirely by Stripe. We do not store card
            details. Stripe's privacy policy applies to payment data.
          </p>
          <p>
            <strong style={{ color: "var(--fg)" }}>Your rights:</strong> You
            have the right to access, correct, or delete your data. Email{" "}
            <a
            ...
            to exercise these rights. You can also lodge a complaint with the
            ICO at ico.org.uk.
          </p>
          <p>
            <strong style={{ color: "var(--fg)" }}>Cookies:</strong> We use
            essential cookies (session management) and, with your consent,
            analytics cookies. Withdraw consent anytime by clearing cookies in
  ...
  return (
    ...
    >
      <div style={{ textAlign: "center", marginBottom: 64 }}>
        ...
        >
          Every job is quoted before we move. The price we say is the price you
          pay.
        </p>
      </div>
      <div
        ...
        {plans.map((p, i) => (
          ...
          >
            <div>
              ...
              <div style={{ fontWeight: 600, fontSize: 22, marginBottom: 4 }}>
                {p.name}
              </div>
              <div
                style={{
      ...
      >
        All prices exclude VAT where applicable. Congestion zone surcharges may
        apply. Ask when quoting.
      </p>
    </section>
  );
}
